...
// go build merkaba.go
// ./merkaba
// convert -loop 0 -delay 1 out0*.png out.gif
...
func main() {
	...
	for i := 0; i < 90; i += 1 {
		...
		render(shape, fmt.Sprintf("out%03d.png", i))
	}
}

func render(shape ln.Shape, path string) {
	// create a scene
	scene := ln.Scene{}
	...
	eye := ln.Vector{4, 4, 4}    // camera position
	...
	fovy := 40.0     // vertical field of view, degrees
